...
#define BLYNK_TEMPLATE_ID "TMPL6Q8sQnVFO"
#define BLYNK_TEMPLATE_NAME "Quickstart Template"
#define BLYNK_AUTH_TOKEN "AA59R6eVLNxNI3xZGDxhFXsXCkco4V0s"
...
#define HUMIDIFIER_PIN 27       //pin out của máy phun xương D27
...
void setup() {
  ...
  Blynk.begin(BLYNK_AUTH_TOKEN, ssid, pass, "blynk.cloud", 80);  //Khởi tạo kết nối với Blynk
...
void sendDhtData(void) {
  Blynk.virtualWrite(V7, tempDht);  //Nhiệt độ với pin V7
  Blynk.virtualWrite(V8, humDht);   // Độ ẩm với pin V8
